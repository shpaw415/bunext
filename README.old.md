...
- Added more test for previous error not to come again
- fix getServerSideProps breaking the request when it's undefined on a route change or refresh on Dev mode
- Quicker development mode reducing exponentially the build time