...
// internal/router/index.tsx
var import_react = __toESM(require_react(), 1);
var import_react_dom = __toESM(require_react_dom(), 1);

// internal/router/utils/get-route-matcher.ts
...
function useRouteState(key, initial) {
  return import_react.useReducer((_old, newvalue) => {
...
async function NextJsLayoutStacker(page, path, currentVersion) {
  let currentPath = "/";
  let layoutStack = [];
  ...
  for await (const p of formatedPath) {
    ...
    if (globalX.__LAYOUT_ROUTE__.includes(normalize(currentPath))) {
      layoutStack.push((await import(normalize(`${globalX.__PAGES_DIR__}${currentPath}/${globalX.__LAYOUT_NAME__}.js?${currentVersion}`))).default);
    }
    if (p.length > 0)
      currentPath += "/";
  }
  ...
  for (const Element of layoutStack) {
    currentJsx = jsx_dev_runtime.jsxDEV(Element, {
      children: currentJsx
...
function useLocationProperty(fn, ssrFn) {
  return import_react.useSyncExternalStore(subscribeToLocationUpdates, fn, ssrFn);
}
...
var VersionContext = import_react.createContext(0);
var useLoadingVersion = () => import_react.useContext(VersionContext);
var useLoadingEffect = (effect, deps = []) => {
  import_react.useEffect(effect, [import_react.useContext(VersionContext), ...deps]);
};
var useReloadEffect = (effect, deps = []) => {
  const [once, setOnce] = import_react.useState(true);
  import_react.useEffect(() => {
    ...
    return effect();
  }, [import_react.useContext(VersionContext), ...deps]);
};
var ReloadContext = import_react.createContext(async () => {
});
var RouterHost = ({
  children,
  ...
  const [current, setCurrent] = import_react.useState(children);
  const [version, setVersion] = import_react.useState(0);
  const versionRef = import_react.useRef(version);
  const reload = import_react.useCallback(async (target = location.pathname + location.search) => {
    ...
    try {
      const [props, module] = await Promise.all([
        ...
        import(`${match(target.split("?")[0]).value}${globalX.__DEV_MODE__ ? `?${currentVersion}` : ""}`)
      ]);
      let JsxToDisplay = jsx_dev_runtime.jsxDEV(module.default, {
        ...props?.props
      }, undefined, false, undefined, this);
      switch (globalX.__DISPLAY_MODE__) {
        case "nextjs":
          JsxToDisplay = await NextJsLayoutStacker(JsxToDisplay, target, currentVersion);
          break;
      }
      if (currentVersion === versionRef.current) {
        if (props?.redirect) {
          ...
          import_react.startTransition(() => {
            ...
            setCurrent(jsx_dev_runtime.jsxDEV(Shell, {
              route: target,
              ...props,
  ...
  return jsx_dev_runtime.jsxDEV(ReloadContext.Provider, {
    value: reload,
    children: jsx_dev_runtime.jsxDEV(VersionContext.Provider, {
      value: version,
      children: current
    }, undefined, false, undefined, this)
  }, undefined, false, undefined, this);
...
async function hydrate(Shell, {
  ...
  let JsxToDisplay = jsx_dev_runtime2.jsxDEV(Initial.default, {
    ...globalX2.__SERVERSIDE_PROPS__?.props
  }, undefined, false, undefined, this);
  switch (globalX2.__DISPLAY_MODE__) {
    case "nextjs":
      JsxToDisplay = await NextJsLayoutStacker2({
  ...
  return client.hydrateRoot(document, jsx_dev_runtime2.jsxDEV(RouterHost, {
    Shell,
    ...options,
    children: jsx_dev_runtime2.jsxDEV(Shell, {
...
async function NextJsLayoutStacker2({
  pageJsx,
  global,
  matched
}) {
  ...
  let currentJsx = jsx_dev_runtime2.jsxDEV(jsx_dev_runtime2.Fragment, {}, undefined, false, undefined, this);
...
// /var/bun_module/buNext/node_modules/@bunpmjs/bunext/componants/head.tsx
var jsx_dev_runtime3 = __toESM(require_jsx_dev_runtime(), 1);
function Head({ currentPath }) {
  const globalX3 = globalThis;
  const data = globalX3.__HEAD_DATA__[currentPath];
  if (!data)
    return jsx_dev_runtime3.jsxDEV("head", {}, undefined, false, undefined, this);
  const res = jsx_dev_runtime3.jsxDEV("head", {
    children: [
      data?.meta?.map((e) => jsx_dev_runtime3.jsxDEV("meta", {
        name: e.name,
        content: e.content
      ...
      Object.keys(data ?? {}).filter((n) => n != "meta").map((e) => {
        const val = data[e];
        if (e === "title")
          return jsx_dev_runtime3.jsxDEV("title", {
            children: val
          }, e, false, undefined, this);
        return jsx_dev_runtime3.jsxDEV("meta", {
          name: e,
          content: val
        }, e, false, undefined, this);
      })
...
function Dev() {
  if (typeof window === "undefined" || !globalThis.__BUNEXT_DEV_INIT)
    return jsx_dev_runtime4.jsxDEV(jsx_dev_runtime4.Fragment, {}, undefined, false, undefined, this);
  else
    globalThis.__BUNEXT_DEV_INIT = false;
  const reload = import_react2.useContext(ReloadContext);
...
var Shell = ({
  ...
  return jsx_dev_runtime5.jsxDEV("html", {
    children: [
      ...
      globalThis.__NODE_ENV__ == "development" ? jsx_dev_runtime5.jsxDEV(Dev, {}, undefined, false, undefined, this) : jsx_dev_runtime5.jsxDEV(jsx_dev_runtime5.Fragment, {}, undefined, false, undefined, this)
    ]
  }, undefined, true, undefined, this);
};
